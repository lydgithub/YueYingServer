...
public class NearbyActivityController {
	...
	@ResponseBody
	public NearbyListModel get(@PathVariable double xPoint,@PathVariable double yPoint,@PathVariable int listid,HttpServletRequest request){
		System.out.println("enter the nearby controller!");
